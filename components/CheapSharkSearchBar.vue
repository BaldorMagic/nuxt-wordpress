<template>
    <div class="mx-auto flex max-w-screen-sm items-center justify-center">
        <div class="p-1.5 rounded-full bg-gradient-to-r from-[#180161] via-[#4F1787] to-[#EB3678] hover:via-[#EB3678] hover:to-[#FB773C] has-[:focus]:to-[#FB773C] has-[:focus]:via-[#EB3678]">
            <div
                class="flex rounded-full overflow-hidden max-w-md mx-auto font-[sans-serif]">
